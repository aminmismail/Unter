...
<p>Funcionamento do software:
  A tela inicial do software conta com <b>(X)</b> opções, as quais o usuário pode escolher. Na opção <b>(X)</b>, o programa (FUNÇÃO). Já na opção <b>(X)</b>, o programa (FUNÇÃO). Caso o usuário escolha a opção <b>(X)</b>, o programa irá (FUNÇÃO). Caso a opção <b>(X)</b> seja escolhida, o programa (FUNÇÃO). Por fim, caso a opção <b>(X)</b> seja selecionada, o programa (FUNÇÃO).<p>
